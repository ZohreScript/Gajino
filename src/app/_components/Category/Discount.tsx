...
function DiscountCard({
  ...
  return (
    <div className="rounded-xl relative overflow-hidden shadow-lg shadow-MokhFont2/50 bg-white">
      ...
      <div className="pb-2 flex flex-col items-center justify-center relative">
        <h2 className="text-md font-bold mb-2 mt-3 text-center text-MokhFont1">
        ...
        <p className="text-lg font-light text-center text-MokhFont1 mb-2">
          {instructor}
        </p>
        <div className="flex items-center flex-col ">
          <span className="relative text-MokhFont2  m-3 font-semibold h-full inline-block">
          ...
          <span className="text-MokhBlue font-bold text-lg">
